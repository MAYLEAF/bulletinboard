          ...
          <form class="col-md-4 mx-auto" action="editcard_process.php" method="post">
            ...
            <div class="text-center">
              ...
              <div class="btn-group btn-group-toggle" data-toggle="buttons">
                ...
                <label class="btn btn-secondary"> <input type="checkbox" name="inputDay3" id="inputDay3" autocomplete="off" value="목"> 목요일 </label>
                <label class="btn btn-secondary"> <input type="checkbox" name="inputDay4" id="inputDay4" autocomplete="off" value="금"> 금요일 </label>
                <label class="btn btn-secondary"> <input type="checkbox" name="inputDay5" id="inputDay5" autocomplete="off" value="토"> 토요일 </label>
