  ...
  <body>
    ...
    <main role="main" >
      <section class="jumbotron">
          ...
          <form class="col-md-4 mx-auto" action="manager_process.php" method="post">
            ...
            <div class="text-center">
              ...
              <input type="text" id="inputArticle" name="inputArticle" class="form-control" placeholder="Enter your Name" required>
